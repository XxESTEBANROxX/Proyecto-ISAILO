      ...
      <head> 
        ...
        <body>
        	 ...
        	 <div id="container">
                ...
                <div class="imagen"><img src="../img/ISAILO.png"></div>
                ...
                <form name="form" action="eleccion_personero" method="post">
                    ...
                    <button><a href="../VISUAL/FINALIZACION.html">VOTAR</a></button>
